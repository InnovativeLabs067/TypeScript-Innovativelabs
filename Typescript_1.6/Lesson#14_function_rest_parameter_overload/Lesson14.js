...
/*function rest_para(...rest_arguments:number[]){
    ...
    {
        console.log("No parameter pass");
    }

}
rest_para(2,3,4,5,6,<any>"pk");
*/
//step#2
...
//rest arguments bydefault are optional
...
//getNames(55, "TypeScript", "Php", "JavaScript", "Jquery");*/
//step#3
...
// e.g of default parameter list
/*function demo1(a:number=2,b:string)
{
...
console.log(typeof overload(2,3));
